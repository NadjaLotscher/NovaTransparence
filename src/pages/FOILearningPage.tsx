...
import { ArrowLeft, CheckCircle, X, ArrowRight, ArrowLeft as ArrowLeftIcon } from 'lucide-react';
...
export const FOILearningPage: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Introduction to Freedom of Information</h1>
        <p className="text-xl text-gray-600">
          Learn the basics of your right to access public information in Switzerland
        </p>
      </div>
      ...
      <div className="space-y-12">
        ...
        <section className="bg-white rounded-xl shadow-lg p-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">What is FOI?</h2>
        ...
        {/* Rights as a Citizen */}
        <section className="bg-white rounded-xl shadow-lg p-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">🧑‍⚖️ What are your rights as a citizen?</h2>
          ...
          <div className="grid gap-4">
            {[
              ...
              <div key={index} className="flex items-start space-x-3 bg-gray-50 border border-gray-200 rounded-lg p-4">
        ...
        <section className="bg-white rounded-xl shadow-lg p-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">📄 What types of information can you request?</h2>
            ...
            <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-purple-100 mt-1">Test what you've learned about FOI</p>
                </div>
                <button
                  onClick={() => {
                    setShowQuiz(false);
              ...
              {!showResults ? (
                ...
                <div className="text-center">
                  <div className={`w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 ${
                    score >= Math.ceil(questions.length * 0.7) ? 'bg-green-100' : 'bg-yellow-100'
                  }`}>
                    <CheckCircle className={`w-12 h-12 ${
                      score >= Math.ceil(questions.length * 0.7) ? 'text-green-600' : 'text-yellow-600'
                    }`} />
                  </div>

                  <h3 className="text-2xl font-bold text-gray-900 mb-4">
                    {score >= Math.ceil(questions.length * 0.7) ? 'Great Job!' : 'Good Effort!'}
                  </h3>
